...
//*******************
	...
	static clone(wellOrigin, layer) {
		const wellClone = new Well({Index: wellOrigin.Index, Row: wellOrigin.Row, Col: wellOrigin.Col, Layer: layer});
		wellClone.Value = wellOrigin.Value;
		wellClone.Conc = wellOrigin.Conc;
