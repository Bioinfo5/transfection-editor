...
class LinkCtrl {
	constructor(I) {
		...
		this.change = (I.Change || (v => this.setValue(v))); //Additional function to run in case the value of the control is changed. The function will receive the new value
	...
	static icon(I) { //Create the html needed to display an icon, based on the provided options
		...
		switch(I.Type) {
			...
			case "Select": position = "-100px 0px"; break;
